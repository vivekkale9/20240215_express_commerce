 ...
 * created
 */
const Database = require('../20240211/MyDatabase');
...
app.delete('/cancel', async (req, res) => {
  ...
  try{
    ...
    console.log("     this is my current stock    "+currentStock);
    ...
    console.log("    THis is my quantity    "+prod_quantity);
    // to update the stock back in product table
    let updatedQuantity = currentStock + prod_quantity
    console.log("    This is my updated   "+updatedQuantity);
